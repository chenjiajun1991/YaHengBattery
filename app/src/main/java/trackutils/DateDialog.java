...
//    private static int theme = android.R.style.Theme_Holo_Light_Dialog; // 主题
    private static int theme = android.R.style.Theme_DeviceDefault_Dialog_NoActionBar_MinWidth; // 主题
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LayoutParams lparamsHours = new LayoutParams(width*7/8, height / 5);
