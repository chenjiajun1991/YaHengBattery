...
public class Geofence implements OnClickListener {
    ...
    protected static void addEntity() {
        ...
        String columnKey = "";
        BaiduTranceActivity.client.addEntity(BaiduTranceActivity.serviceId, entityName, columnKey, BaiduTranceActivity.entityListener);
    }
    ...
    private void createFence() {
        ...
        // 创建者（entity标识）
        String creator = BaiduTranceActivity.entityName;
        // 围栏名称
        String fenceName = BaiduTranceActivity.entityName + "_fence";
        // 围栏描述
        String fenceDesc = "test";
        // 监控对象列表（多个entityName，以英文逗号"," 分割）
        String monitoredPersons = BaiduTranceActivity.entityName;
        // 观察者列表（多个entityName，以英文逗号"," 分割）
        String observers = BaiduTranceActivity.entityName;
        // 生效时间列表
        ...
        BaiduTranceActivity.client.createCircularFence(BaiduTranceActivity.serviceId, creator, fenceName, fenceDesc,
    ...
    private static void deleteFence(int fenceId) {
        BaiduTranceActivity.client.deleteFence(BaiduTranceActivity.serviceId, fenceId, geoFenceListener);
    }
    ...
    private void updateFence() {
        ...
        BaiduTranceActivity.client.updateCircularFence(BaiduTranceActivity.serviceId, fenceName, fenceId, fenceDesc,
                monitoredPersons,
    ...
    private void queryFenceList() {
        ...
        // 围栏ID列表
        String fenceIds = "";
        BaiduTranceActivity.client.queryFenceList(BaiduTranceActivity.serviceId, creator, fenceIds, geoFenceListener);
    }
    ...
    private void monitoredStatus() {
        ...
        // 监控对象列表（多个entityName，以英文逗号"," 分割）
        String monitoredPersons = BaiduTranceActivity.entityName;
        BaiduTranceActivity.client.queryMonitoredStatus(BaiduTranceActivity.serviceId, fenceId, monitoredPersons,
                geoFenceListener);
    }
    ...
    private void historyAlarm() {
        ...
        BaiduTranceActivity.client.queryFenceHistoryAlarmInfo(BaiduTranceActivity.serviceId, fenceId, monitoredPersons, beginTime,
                endTime,
                geoFenceListener);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_setFence:
                inputDialog();
                BaiduTranceActivity.mBaiduMap.setOnMapClickListener(mapClickListener);
                popupwindow.dismiss();
                break;
        ...
        builder.setTitle("围栏半径(单位:米)").setView(circleRadius)
                .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // TODO Auto-generated method stub
                        BaiduTranceActivity.mBaiduMap.setOnMapClickListener(null);
                    }
    ...
    private void showMessage(String message) {
        Looper.prepare();
        Toast.makeText(BaiduTranceActivity.mContext, message, Toast.LENGTH_LONG).show();
        Looper.loop();
    }
