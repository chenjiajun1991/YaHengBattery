...
package jim.h.common.android.zxinglib.camera;
...
public final class CameraManager {
  ...
  // XXX modified by Jim.H @2011/7/19
//  private final Context context;
  ...
  private boolean useFrontLight = false;
  /**
  ...
  private CameraManager(Context context, boolean useFrontLight) {

      // XXX modified by Jim.H @2011/7/19
//    this.context = context;
    this.configManager = new CameraConfigurationManager(context);
    this.useFrontLight = useFrontLight;
